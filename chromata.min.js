        ...
        i(t, null, {
          ...
          _mergeOptions: {
            value: function(t) {
              ...
              return (
                (i.origin =
                  i.origin.constructor === Array ? i.origin : e.origin),
                (i.pathFinderCount = this._limitToRange(
                  i.pathFinderCount,
                  1,
                  1e4
                )),
                ...
                (i.turningAngle = this._limitToRange(i.turningAngle, 0.1, 10)),
                i
              );
            },
            writable: !0,
            ...
            value: function() {
              ...
              (this.sourceImageElement.style.display = "none"),
                t.insertBefore(
                  ...
                  this.sourceImageElement.nextSibling
                );
            },
            writable: !0,
            enumerable: !0,
          ...
          _removeRenderCanvas: {
            value: function() {
              (this.sourceImageElement.style.display = ""),
                this.renderContext.canvas.parentNode.removeChild(
                  this.renderContext.canvas
                );
            },
            writable: !0,
          ...
          _run: {
            value: function() {
              ...
              this._appendRenderCanvas(),
                ...
                (this._tick = function() {
                  0 < t.options.iterationLimit &&
                    t.options.iterationLimit <= t.iterationCount &&
                    ((t.isRunning = !1), (t.options.iterationLimit = 0)),
          ...
          _seedPoint: {
            value: function(t, e, i, n, r) {
              for (
                var s = Math.floor((this.dimensions.width * n) / 100),
                  a = Math.floor((this.dimensions.height * r) / 100),
                  u = 1;
                u < t + 1;
                u++
              ) {
  ...
  var r = 255,
    o = (function() {
      function t(t, i, n) {
        ...
        (this.pixelArray = t),
          (this.workingArray = i),
          (this.arrayWidth = t[0].length),
          (this.arrayHeight = t.length),
          (this.x = Math.round(o)),
          (this.y = Math.round(a)),
          (this.options = h),
          (this.pathQueue = new s(10)),
          (this.velocity = h.startingVelocity),
          (this.targetColor = "string" == typeof n ? this._hexToRgb(n) : n),
          (this.rgbIndex = this._getRgbIndex(this.targetColor)),
          "low" === this.options.key
        ...
        i(t, null, {
            ...
            value: function() {
              for (
                var t,
                  e,
                  i,
                  n = this._getVelocityAngle(),
                  o = "low" === this.options.key ? 1e5 : 0,
                  s = this.options.turningAngle,
                  a = Math.round(
                    Math.sqrt(
                ...
                if (this._isInRange(l, c)) {
                  var d = this.workingArray[c][l][this.rgbIndex],
                    ...
                    b = f[3];
                  (g = this._getColorDistance(f)),
                    this.comparatorFn(g, o) &&
                      !d &&
                      b === r &&
                      ((e = [l, c, r - g]), (o = g));
                }
                if (0 === u) {
                  ...
                  i =
                    p[c] && p[c][l] && p[c][l][3] === r
                      ? [l, c, r - g]
                      : this.pathQueue.get(-2);
                }
              }
              return (
                (t = void 0 !== e),
                (e = e || i) &&
                  ((this.velocity = [e[0] - this.x, e[1] - this.y]),
                  (this.y = e[1]),
                  (this.x = e[0]),
                  this._updateWorkingArray(e[1], e[0]),
                  this.pathQueue.put(e)),
                { nextPixel: e, isPristine: t }
              );
            },
            writable: !0,
            enumerable: !0,
          ...
          _getVelocityAngle: {
            value: function() {
              ...
              return (
                (t <= i || this.arrayWidth - i <= t) && (r *= -1),
                (e <= i || this.arrayHeight - i <= e) && (n *= -1),
                Math.atan2(n, r)
              );
            },
            writable: !0,
          ...
          _isInRange: {
            value: function(t, e) {
              return (
                0 < t && t < this.arrayWidth && 0 < e && e < this.arrayHeight
              );
            },
            writable: !0,
            enumerable: !0,
      ...
      return (
        i(t, null, {
          put: {
            value: function(t) {
              this.queue.push(t),
                this.size < this.queue.length && this.queue.shift();
            },
            writable: !0,
            enumerable: !0,
            configurable: !0
    ...
    a = (function() {
      ...
      return (
        i(t, null, {
          drawNextLine: {
            value: function() {
              "smooth" === this.options.lineMode
                ? this._drawLineSmooth()
                : "square" === this.options.lineMode
          ...
          _drawLineSmooth: {
            value: function() {
              ...
              if (n) {
                if (
                  (void 0 === this.currentPoint && (this.currentPoint = n),
                  void 0 === this.controlPoint && (this.controlPoint = n),
                  (t = Math.round((this.controlPoint[0] + n[0]) / 2)),
                  (e = Math.round((this.controlPoint[1] + n[1]) / 2)),
                  (i = Math.floor((this.currentPoint[2] + n[2]) / 2)),
                  this._getLineLength(this.currentPoint, n) <=
                    3 * this.options.speed)
                ) {
                  var r,
                    o = this.currentPoint[2],
                    s = n[2];
                  (r = this._createGradient(this.currentPoint, n, o, s)),
          ...
          _drawLineSquare: {
            value: function() {
              ...
              if (t) {
                if (
                  (void 0 === this.currentPoint && (this.currentPoint = t),
                  this._getLineLength(this.currentPoint, t) <=
                    this.options.speed + 1)
                ) {
                  var e,
                    i = this.currentPoint[2],
                    n = t[2];
                  (e = this._createGradient(this.currentPoint, t, i, n)),
            ...
            value: function() {
              ...
              t &&
                ...
                this._getLineLength(this.currentPoint, t) >=
                  ...
                  (this.context.fillStyle = this._getStrokeColor(t[2])),
                  this.context.fill(),
                  (this.currentPoint = t)));
            },
            writable: !0,
          ...
          _createGradient: {
            value: function(t, e, i, n) {
              ...
              return (
                r.addColorStop(0, this._getStrokeColor(i)),
                r.addColorStop(1, this._getStrokeColor(n)),
                r
              );
            },
            writable: !0,
          ...
          _getStrokeColor: {
            value: function(t) {
              return "color" === this.options.colorMode
                ? "rgba(" +
                    (0 !== this.color.r ? t : 0) +
                    ", " +
                    (0 !== this.color.g ? t : 0) +
      ...
      return (
        i(t, {
          ...
          _getImageArray: {
            value: function(t) {
              for (
                ...
                r.push([]);
                for (var s = 0; s < e; s++) {
                  for (var a = [], h = o * e * 4 + 4 * s, u = 0; u < 4; u++)
                    a[u] = n.data[h + u];
                  r[o].push(a);
                }
              }
          ...
          _getWorkingArray: {
            value: function(t) {
              for (
                var e = t.canvas.width, i = t.canvas.height, n = [], r = 0;
                r < i;
                r++
              ) {
                n.push([]);
          ...
          _getOutputDimensions: {
            value: function(t, e) {
              var i, n;
              if ("original" === e) (i = t.width), (n = t.height);
              else {
                var r = t.parentNode,
